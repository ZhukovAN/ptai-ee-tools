...
import static com.ptsecurity.appsec.ai.ee.server.v471.helpers.ApiHelper.PROJECTS;
import static com.ptsecurity.appsec.ai.ee.server.v471.helpers.ApiHelper.STORE;
...
public abstract class AbstractTest extends BaseTest {
    ...
    protected static void createTestProject() {
        ...
        DefaultProjectSettingsModel defaultProjectSettings = call(
                com.ptsecurity.appsec.ai.ee.server.v471.helpers.ApiHelper.PROJECTS::apiProjectsDefaultSettingsGet,
        ...
        CreateProjectSettingsModel projectSettings = new CreateProjectSettingsModel()
                ...
                .name(PROJECT_NAME)
                .languages(Collections.singletonList(LegacyProgrammingLanguageGroup.PHP))
