package com.ptsecurity.appsec.ai.ee.server.v450.helpers;

import com.ptsecurity.appsec.ai.ee.server.helpers.AbstractApiHelper;
import com.ptsecurity.appsec.ai.ee.server.v450.api.ApiClient;
...
import com.ptsecurity.appsec.ai.ee.server.v450.auth.model.AuthScopeType;
...
public class ApiHelper extends AbstractApiHelper {
    ...
    public final static AuthApi AUTH = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v450.auth.ApiClient());
