...
import com.ptsecurity.appsec.ai.ee.server.v471.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.server.v471.helpers.ApiHelper.*;
import static org.apache.http.HttpStatus.SC_BAD_REQUEST;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.7.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V471 })
public class FastTest extends com.ptsecurity.appsec.ai.ee.server.v471.AbstractTest {
    @BeforeAll
    public static void init() {
        com.ptsecurity.appsec.ai.ee.server.v471.AbstractTest.init();
        com.ptsecurity.appsec.ai.ee.server.v471.AbstractTest.authenticate();
        com.ptsecurity.appsec.ai.ee.server.v471.AbstractTest.createTestProject();
    }
    ...
    public void getAllProjects() {
        List<ProjectModel> all = checkApiCall(PROJECTS::apiProjectsGet, TokenType.CI);
    ...
    public void checkProjectNotExist() {
        ...
        log.trace("Check that PT AI v.4.5.0 API returns HTTP status 400 if there's no project with given Id");
    ...
    public void readWriteProjectSastSettings() {
        ...
        assertEquals(Boolean.FALSE, settings.getWhiteBoxSettings().getStaticCodeAnalysisEnabled());
        ...
        settings.getWhiteBoxSettings().setStaticCodeAnalysisEnabled(false);
        ...
        assertEquals(Boolean.FALSE, changedSettings.getWhiteBoxSettings().getStaticCodeAnalysisEnabled());
    }
    ...
    public void readWriteProjectSecurityPolicy() {
        ...
        assertEquals(Boolean.TRUE, changedSecurityPolicies.getCheckSecurityPoliciesAccordance());
    }
}