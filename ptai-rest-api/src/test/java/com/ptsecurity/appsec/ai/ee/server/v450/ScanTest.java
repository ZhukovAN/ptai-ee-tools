package com.ptsecurity.appsec.ai.ee.server.v450;
...
import com.ptsecurity.appsec.ai.ee.server.v450.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V450;
...
import static com.ptsecurity.appsec.ai.ee.server.v450.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v450.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.5.0 REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V450 })
