package com.ptsecurity.appsec.ai.ee.server.v471.helpers;

import com.ptsecurity.appsec.ai.ee.server.helpers.AbstractApiHelper;
import com.ptsecurity.appsec.ai.ee.server.v471.api.ApiClient;
...
public class ApiHelper extends AbstractApiHelper {
    ...
    public final static AuthApi AUTH = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v471.auth.ApiClient());
