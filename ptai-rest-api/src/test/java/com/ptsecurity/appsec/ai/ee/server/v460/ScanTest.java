package com.ptsecurity.appsec.ai.ee.server.v460;
...
import com.ptsecurity.appsec.ai.ee.server.v460.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V460;
...
import static com.ptsecurity.appsec.ai.ee.server.v460.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v460.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.6.0 REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V460 })
public class ScanTest extends AbstractTest {
    ...
    @Test
    @DisplayName("Get test project scan result errors")
    public void getProjectScanErrors() {
        List<ScanErrorModel> errors = checkApiCall(() -> PROJECTS.apiProjectsProjectIdScanResultsScanResultIdErrorsGet(PROJECT_ID, SCAN_RESULT_ID));
    ...
    public void getProjectScanSettings() {
        ...
        assertEquals(scanSettings.getProgrammingLanguage(), ProgrammingLanguage.PHP);
    }
    ...
    public void getScanSettings() {
        ...
        assertEquals(settings.getProgrammingLanguage(), ScanBrief.ScanSettings.Language.PHP);
    }
}
