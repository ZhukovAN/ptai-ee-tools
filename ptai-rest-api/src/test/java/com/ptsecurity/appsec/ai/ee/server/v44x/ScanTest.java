...
import com.ptsecurity.appsec.ai.ee.server.v44x.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.server.v44x.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v44x.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.4.X REST API calls that require scan")
@Tag("integration")
@Tag("scan")
