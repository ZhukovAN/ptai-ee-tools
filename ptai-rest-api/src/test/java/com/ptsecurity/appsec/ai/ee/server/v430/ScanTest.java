package com.ptsecurity.appsec.ai.ee.server.v430;
...
import com.ptsecurity.appsec.ai.ee.server.v430.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.server.v430.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v430.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.3.X REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V430 })
