...
public class BaseIT extends BaseTest {
    public static final String EXISTING_PHP_SMOKE_MEDIUM_PROJECT = "php-smoke-medium";
    public static final String EXISTING_PHP_SMOKE_HIGH_PROJECT = "php-smoke-high";
