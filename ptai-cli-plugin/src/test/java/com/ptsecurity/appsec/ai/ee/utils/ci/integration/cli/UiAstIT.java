...
class UiAstIT extends BaseCliAstIT {
    ...
    void testUiAstShowUsage(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast");
    ...
    void testExistingProject(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--truststore", CA_PEM_FILE.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken());
    ...
    void testNoSourcesIncluded(@NonNull final TestInfo testInfo) {
        log.trace(testInfo.getDisplayName());
        PHP_SMOKE_MEDIUM.setup();
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--truststore", CA_PEM_FILE.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--includes", "**/*.java", "--excludes", "**/*");
    ...
    void testPolicyFailForExistingProject(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_HIGH.getName(), "--input", PHP_SMOKE_HIGH.getCode().toString(), "--output", destination.toString(), "--truststore", CA_PEM_FILE.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--fail-if-failed");
        Assertions.assertEquals(BaseCommand.ExitCode.FAILED.getCode(), res);
    }
    ...
    void testMissingProject(@NonNull final TestInfo testInfo) {
        log.trace(testInfo.getDisplayName());
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName() + UUID.randomUUID(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--truststore", CA_PEM_FILE.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken());
        Assertions.assertEquals(BaseCommand.ExitCode.FAILED.getCode(), res);
    }
    ...
    void testWithoutTruststore(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--truststore", DUMMY_CA_PEM_FILE.toString());
        Assertions.assertEquals(BaseCommand.ExitCode.FAILED.getCode(), res);
    }
    ...
    void testInsecureWithoutTruststore(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--insecure");
        Assertions.assertEquals(BaseCommand.ExitCode.SUCCESS.getCode(), res);
    }
    ...
    void testReportRewrite(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--truststore", CA_PEM_FILE.toString(), "--report-file", report.getFileName().toString(), "--report-template", "OWASP top 10 2017 report", "--report-format", HTML.name(), "--report-locale", EN.name());
        Assertions.assertEquals(BaseCommand.ExitCode.SUCCESS.getCode(), res);
        ...
        res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--truststore", CA_PEM_FILE.toString(), "--report-file", report.getFileName().toString(), "--report-template", "OWASP top 10 2017 report", "--report-format", HTML.name(), "--report-locale", EN.name());
        Assertions.assertEquals(BaseCommand.ExitCode.SUCCESS.getCode(), res);
        Assertions.assertTrue(report.toFile().exists());
    ...
    void testJsonDefinedReports(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--truststore", CA_PEM_FILE.toString(), "--report-json", reportsJson.toString());
        Assertions.assertEquals(BaseCommand.ExitCode.SUCCESS.getCode(), res);
    ...
    void testExistingProjectAsync(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--truststore", CA_PEM_FILE.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--async");
        Assertions.assertEquals(BaseCommand.ExitCode.SUCCESS.getCode(), res);
    }
    ...
    void testMissingProjectAsync(@NonNull final TestInfo testInfo) {
        ...
        Integer res = new CommandLine(new Plugin()).execute("ui-ast", "--project", BaseAstIT.PHP_SMOKE_MEDIUM.getName() + UUID.randomUUID(), "--input", PHP_SMOKE_MEDIUM.getCode().toString(), "--output", destination.toString(), "--truststore", CA_PEM_FILE.toString(), "--url", CONNECTION().getUrl(), "--token", CONNECTION().getToken(), "--async");
        Assertions.assertEquals(BaseCommand.ExitCode.FAILED.getCode(), res);
    }
