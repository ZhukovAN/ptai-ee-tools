...
script("""
    function testPt(button) { 
        ...
        validateButton('${descriptor.descriptorFullUrl}/testProject','selectedScanSettings,selectedConfig,jsonSettings,jsonPolicy,projectName,serverUrl,serverCredentialsId,jenkinsServerUrl,jenkinsJobName,credentialsId,userName,apiToken,configName',button);
    }
""")
...
f.block() {
    pt.validateButton(
            ...
            method: 'testProject',
            with: 'jsonSettings,jsonPolicy,projectName,serverUrl,serverCredentialsId,jenkinsServerUrl,jenkinsJobName,credentialsId,userName,apiToken,configName',
