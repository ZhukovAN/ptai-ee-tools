...
import com.ptsecurity.appsec.ai.ee.server.v470.api.model.ScanAgentModel;
import com.ptsecurity.appsec.ai.ee.server.v470.auth.ApiResponse;
...
import com.ptsecurity.appsec.ai.ee.server.v470.notifications.model.*;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.AbstractApiClient;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.VersionRange;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v470.converters.EnumsConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v470.tasks.GenericAstTasksImpl;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v470.tasks.ServerVersionTasksImpl;
...
import static com.ptsecurity.appsec.ai.ee.server.v470.auth.model.AuthScope.ACCESSTOKEN;
import static com.ptsecurity.appsec.ai.ee.server.v470.auth.model.AuthScope.WEB;
import static com.ptsecurity.appsec.ai.ee.server.v470.notifications.model.Stage.*;
...
public class ApiClient extends AbstractApiClient {
    ...
    @Getter
    @ToString.Exclude
    protected final AuthApi authApi = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v470.auth.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ProjectsApi projectsApi = new ProjectsApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ReportsApi reportsApi = new ReportsApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ConfigsApi configsApi = new ConfigsApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final LicenseApi licenseApi = new LicenseApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanQueueApi scanQueueApi = new ScanQueueApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanAgentApi scanAgentApi = new ScanAgentApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final StoreApi storeApi = new StoreApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final HealthCheckApi healthCheckApi = new HealthCheckApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final VersionApi versionApi = new VersionApi(new com.ptsecurity.appsec.ai.ee.server.v470.api.ApiClient());
    ...
    public ScanBrief.ApiVersion getApiVersion() {
        return ScanBrief.ApiVersion.V470;
    }
        ...
        connection.on("ScanProgress", (data) -> {
            ...
            if (!scanBrief.getId().equals(data.getScanResultId()))
                ...
                builder.append(Optional.of(data)
                        ...
                        .map(com.ptsecurity.appsec.ai.ee.server.v470.notifications.model.Stage::getValue)
                ...
                Optional<com.ptsecurity.appsec.ai.ee.server.v470.notifications.model.Stage> stage = Optional.of(data).map(ScanProgress::getProgress).map(ScanProgressModel::getStage);
                if (stage.isPresent()) {
