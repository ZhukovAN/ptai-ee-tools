package com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v430.tasks;

import com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ScanSettings.Language;
import com.ptsecurity.appsec.ai.ee.scan.settings.Policy;
import com.ptsecurity.appsec.ai.ee.scan.settings.v430.AiProjScanSettings;
import com.ptsecurity.appsec.ai.ee.server.v430.api.ApiException;
import com.ptsecurity.appsec.ai.ee.server.v430.api.model.*;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.AbstractApiClient;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v430.converters.AiProjConverter;
...
public class ProjectTasksImpl extends AbstractTaskImpl implements ProjectTasks {
        ...
        ProjectModel projectModel = call(
                () -> {
                    try {
                        ...
                        log.trace("PT AI v.4.2 API returns HTTP status 204 if there's no project with given name {}", name);
    ...
    public JsonParseBrief setupFromJson(@NonNull final String jsonSettings, final String jsonPolicy, @NonNull final Consumer<UUID> uploader) throws GenericException {
        ...
        ProjectSettingsUpdatedModel projectSettingsUpdatedModel = new ProjectSettingsUpdatedModel()
                ...
                .programmingLanguageGroup(projectSettingsModel.getProgrammingLanguageGroup())
                .whiteBoxSettings(projectSettingsModel.getWhiteBoxSettings())
                .launchParameters(projectSettingsModel.getLaunchParameters())
                .useAvailablePublicAndProtectedMethods(projectSettingsModel.getUseAvailablePublicAndProtectedMethods())
    ...
    public List<Pair<UUID, String>> listProjects() throws GenericException {
        // PT AI v.4.2 supports project list load:
