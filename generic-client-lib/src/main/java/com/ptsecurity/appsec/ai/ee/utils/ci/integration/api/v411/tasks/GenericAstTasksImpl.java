...
import com.ptsecurity.appsec.ai.ee.server.v411.legacy.model.ScanError;
import com.ptsecurity.appsec.ai.ee.server.v411.legacy.model.ScanResultStatistic;
import com.ptsecurity.appsec.ai.ee.server.v411.legacy.model.V411ScanSettings;
import com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.ScanSettingsModel;
import com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.ScanStatisticModel;
...
import static com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.Stage.*;
...
public class GenericAstTasksImpl extends AbstractTaskImpl implements GenericAstTasks {
    ...
    public static class ProjectPollingThread implements Runnable {
        private static final Map<com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.Stage, Stage> STAGE_MAP = new HashMap<>();
        static {
            // There's no need to fill dictionary with all the defined enum values as we need to process these three only
            STAGE_MAP.put(com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.Stage.DONE, DONE);
            STAGE_MAP.put(com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.Stage.FAILED, FAILED);
            STAGE_MAP.put(com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.Stage.ABORTED, ABORTED);
        }
        ...
        public void run() {
            while (!exit) {
                try {
                    ...
                    com.ptsecurity.appsec.ai.ee.server.v411.legacy.model.ScanResult scanResult = call(
    ...
    public ScanBrief createScanBrief(@NonNull final UUID projectId, @NonNull final UUID scanResultId) throws GenericException {
        ...
        V411ScanSettings scanSettings = call(
    ...
    public void appendStatistics(@NonNull final ScanBrief scanBrief) throws GenericException {
        ...
        com.ptsecurity.appsec.ai.ee.server.v411.projectmanagement.model.ScanResultModel scanResult = call(
