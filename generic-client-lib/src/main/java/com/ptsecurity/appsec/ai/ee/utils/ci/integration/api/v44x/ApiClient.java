package com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v44x;
...
import com.ptsecurity.appsec.ai.ee.server.v44x.api.api.*;
import com.ptsecurity.appsec.ai.ee.server.v44x.api.model.ScanAgentModel;
import com.ptsecurity.appsec.ai.ee.server.v44x.auth.ApiResponse;
...
import com.ptsecurity.appsec.ai.ee.server.v44x.auth.model.UserLoginModel;
import com.ptsecurity.appsec.ai.ee.server.v44x.notifications.model.*;
...
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v44x.tasks.GenericAstTasksImpl;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v44x.tasks.ServerVersionTasksImpl;
...
import static com.ptsecurity.appsec.ai.ee.server.v44x.auth.model.AuthScopeType.ACCESSTOKEN;
import static com.ptsecurity.appsec.ai.ee.server.v44x.auth.model.AuthScopeType.WEB;
import static com.ptsecurity.appsec.ai.ee.server.v44x.notifications.model.Stage.ABORTED;
import static com.ptsecurity.appsec.ai.ee.server.v44x.notifications.model.Stage.FAILED;
import static com.ptsecurity.misc.tools.helpers.CallHelper.call;

@Slf4j
@VersionRange(min = { 4, 4, 0, 0 }, max = { 4, 4, 99999, 99999 })
public class ApiClient extends AbstractApiClient {
    ...
    @Getter
    @ToString.Exclude
    protected final AuthApi authApi = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v44x.auth.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ProjectsApi projectsApi = new ProjectsApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ReportsApi reportsApi = new ReportsApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ConfigsApi configsApi = new ConfigsApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final LicenseApi licenseApi = new LicenseApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanQueueApi scanQueueApi = new ScanQueueApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanAgentApi scanAgentApi = new ScanAgentApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final StoreApi storeApi = new StoreApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final HealthCheckApi healthCheckApi = new HealthCheckApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final VersionApi versionApi = new VersionApi(new com.ptsecurity.appsec.ai.ee.server.v44x.api.ApiClient());
    ...
    public ScanBrief.ApiVersion getApiVersion() {
        return ScanBrief.ApiVersion.V44X;
    }
        ...
        connection.on("ScanProgress", (data) -> {
            ...
            if (!scanBrief.getId().equals(data.getScanResultId()))
                ...
                builder.append(Optional.of(data)
                        ...
                        .map(com.ptsecurity.appsec.ai.ee.server.v44x.notifications.model.Stage::getValue)
                ...
                Optional<com.ptsecurity.appsec.ai.ee.server.v44x.notifications.model.Stage> stage = Optional.of(data).map(ScanProgress::getProgress).map(ScanProgressModel::getStage);
                if (stage.isPresent()) {
