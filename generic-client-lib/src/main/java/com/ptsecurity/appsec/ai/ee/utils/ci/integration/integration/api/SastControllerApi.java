...
public class SastControllerApi extends com.ptsecurity.appsec.ai.ee.ptai.integration.rest.SastControllerApi {
    ...
    public SastControllerApi(ApiClient client) { super(client); }
}
