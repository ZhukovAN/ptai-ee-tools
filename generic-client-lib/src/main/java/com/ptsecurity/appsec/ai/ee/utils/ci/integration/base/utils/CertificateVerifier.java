...
public class CertificateVerifier {
    ...
    private static PKIXCertPathBuilderResult verifyCertificate(
        ...
        // Configure the PKIX certificate xml algorithm parameters
     ...
     * @return the certification chain (if verification is successful)
     * @throws BaseClientException - if the certification is not
    ...
    public static PKIXCertPathBuilderResult verifyCertificate(X509Certificate cert, Set<X509Certificate> additionalCerts)
        ...
        try {
            ...
            if (isSelfSigned(cert))
                throw new PtaiClientException ("The certificate is self-signed.");
            ...
            throw new BaseClientException("Error building certification path: " + cert.getSubjectX500Principal(), certPathEx);
        } catch (Exception ex) {
            throw new BaseClientException("Error verifying the certificate: " + cert.getSubjectX500Principal(), ex);
        }
    }
}
