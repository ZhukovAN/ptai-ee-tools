...
import com.ptsecurity.appsec.ai.ee.server.v42.api.api.*;
import com.ptsecurity.appsec.ai.ee.server.v42.api.model.AuthResultModel;
import com.ptsecurity.appsec.ai.ee.server.v42.api.model.AuthScopeType;
import com.ptsecurity.appsec.ai.ee.server.v42.api.model.UserLoginModel;
...
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v42.converters.EnumsConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v42.events.ScanCompleteEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v42.events.ScanProgressEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v42.events.ScanResultRemovedEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v42.events.ScanStartedEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v42.tasks.ServerVersionTasksImpl;
...
import static com.ptsecurity.appsec.ai.ee.server.v42.notifications.model.Stage.ABORTED;
import static com.ptsecurity.appsec.ai.ee.server.v42.notifications.model.Stage.FAILED;
...
public class ApiClient extends AbstractApiClient {
    ...
    @Getter
    @ToString.Exclude
    protected final AuthApi authApi = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ProjectsApi projectsApi = new ProjectsApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ReportsApi reportsApi = new ReportsApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ConfigsApi configsApi = new ConfigsApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final LicenseApi licenseApi = new LicenseApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanQueueApi scanQueueApi = new ScanQueueApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanAgentApi scanAgentApi = new ScanAgentApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final StoreApi storeApi = new StoreApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final HealthCheckApi healthCheckApi = new HealthCheckApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());

    @Getter
    @ToString.Exclude
    protected final VersionApi legacyVersionApi = new VersionApi(new com.ptsecurity.appsec.ai.ee.server.v42.api.ApiClient());
    ...
    public ScanBrief.ApiVersion getApiVersion() {
        return ScanBrief.ApiVersion.V42;
    }
        ...
        connection.on("ScanProgress", (data) -> {
            if (!scanResultId.equals(data.getScanResultId()))
                ...
                builder.append(Optional.of(data)
                        ...
                        .map(com.ptsecurity.appsec.ai.ee.server.v42.notifications.model.Stage::getValue)
                ...
                Optional<com.ptsecurity.appsec.ai.ee.server.v42.notifications.model.Stage> stage = Optional.of(data).map(ScanProgressEvent::getProgress).map(ScanProgress::getStage);
                if (stage.isPresent()) {
