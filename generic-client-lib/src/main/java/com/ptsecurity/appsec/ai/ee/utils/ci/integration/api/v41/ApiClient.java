...
import com.ptsecurity.appsec.ai.ee.server.v41.auth.ApiResponse;
import com.ptsecurity.appsec.ai.ee.server.v41.auth.api.AuthApi;
import com.ptsecurity.appsec.ai.ee.server.v41.auth.model.AuthResultModel;
import com.ptsecurity.appsec.ai.ee.server.v41.auth.model.AuthScopeType;
import com.ptsecurity.appsec.ai.ee.server.v41.auth.model.UserLoginModel;
import com.ptsecurity.appsec.ai.ee.server.v41.filesstore.api.StoreApi;
import com.ptsecurity.appsec.ai.ee.server.v41.legacy.api.ProjectsApi;
import com.ptsecurity.appsec.ai.ee.server.v41.legacy.api.ReportsApi;
import com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.api.ConfigsApi;
import com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.api.LicenseApi;
import com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.model.ScanProgress;
import com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.model.Stage;
import com.ptsecurity.appsec.ai.ee.server.v41.scanscheduler.api.ScanAgentApi;
import com.ptsecurity.appsec.ai.ee.server.v41.scanscheduler.api.ScanQueueApi;
import com.ptsecurity.appsec.ai.ee.server.v41.systemmanagement.api.HealthCheckApi;
import com.ptsecurity.appsec.ai.ee.server.v41.updateserver.api.VersionApi;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.AbstractApiClient;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.VersionRange;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v41.converters.EnumsConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v41.events.ScanCompleteEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v41.events.ScanProgressEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v41.events.ScanResultRemovedEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v41.events.ScanStartedEvent;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v41.tasks.ServerVersionTasksImpl;
...
public class ApiClient extends AbstractApiClient {
    ...
    @Getter
    @ToString.Exclude
    protected final AuthApi authApi = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v41.auth.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ProjectsApi legacyProjectsApi = new ProjectsApi(new com.ptsecurity.appsec.ai.ee.server.v41.legacy.ApiClient());

    @Getter
    @ToString.Exclude
    protected final com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.api.ProjectsApi projectsApi = new com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.api.ProjectsApi(new com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.ApiClient());

    @Getter
    @ToString.Exclude
    protected final com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.api.ReportsApi reportsApi = new com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.api.ReportsApi(new com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ConfigsApi configsApi = new ConfigsApi(new com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.ApiClient());

    @Getter
    @ToString.Exclude
    protected final com.ptsecurity.appsec.ai.ee.server.v41.legacy.api.ConfigsApi legacyConfigsApi = new com.ptsecurity.appsec.ai.ee.server.v41.legacy.api.ConfigsApi(new com.ptsecurity.appsec.ai.ee.server.v41.legacy.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ReportsApi legacyReportsApi = new ReportsApi(new com.ptsecurity.appsec.ai.ee.server.v41.legacy.ApiClient());

    @Getter
    @ToString.Exclude
    protected final LicenseApi licenseApi = new LicenseApi(new com.ptsecurity.appsec.ai.ee.server.v41.projectmanagement.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanQueueApi scanQueueApi = new ScanQueueApi(new com.ptsecurity.appsec.ai.ee.server.v41.scanscheduler.ApiClient());

    @Getter
    @ToString.Exclude
    protected final ScanAgentApi scanAgentApi = new ScanAgentApi(new com.ptsecurity.appsec.ai.ee.server.v41.scanscheduler.ApiClient());

    @Getter
    @ToString.Exclude
    protected final StoreApi storeApi = new StoreApi(new com.ptsecurity.appsec.ai.ee.server.v41.filesstore.ApiClient());

    @Getter
    @ToString.Exclude
    protected final HealthCheckApi healthCheckApi = new HealthCheckApi(new com.ptsecurity.appsec.ai.ee.server.v41.systemmanagement.ApiClient());

    @Getter
    @ToString.Exclude
    protected final VersionApi versionApi = new VersionApi(new com.ptsecurity.appsec.ai.ee.server.v41.updateserver.ApiClient());
    ...
    public ScanBrief.ApiVersion getApiVersion() {
        return ScanBrief.ApiVersion.V41;
    }
