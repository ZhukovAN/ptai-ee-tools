...
public class PtaiPlugin extends Builder implements SimpleBuildStep {
    ...
    public void perform(@Nonnull Run<?, ?> build, @Nonnull FilePath workspace, @Nonnull Launcher launcher, @Nonnull TaskListener listener) throws InterruptedException, IOException {
        ...
        try {
            ...
            verboseLog(listener,Messages.validator_successPtaiAuthToken(ptaiToken.substring(0, 10)) + "\r\n");
            ...
            log(listener, Messages.validator_failedJenkinsApiDetails(e) + "\r\n");
            throw new AbortException(Messages.validator_failed());
        } catch (PtaiClientException e) {
            log(listener, Messages.validator_failedPtaiApiDetails(e) + "\r\n");
            throw new AbortException(Messages.validator_failed());
        }
    }
