...
${nuget_cmd} install src/AI.Enterprise.Integration.RestApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AI.Enterprise.Integration.RestApi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AI.Enterprise.Integration.RestApi.dll \
-recurse:'src/AI.Enterprise.Integration.RestApi/*.cs' \
-doc:bin/AI.Enterprise.Integration.RestApi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AI.Enterprise.Integration.RestApi.dll was created successfully"
fi
