    ...
    createErrorListener: function() {
        ...
        return OO.extend(BS.ErrorsAwareListener, {
            handle: function(field, elem) {
                $("ptai." + field + "Error").innerHTML = elem.firstChild.nodeValue;
                that.highlightErrorField($("ptai." + field));
            },

            onEmptyUrlError: function(elem) {
                this.handle("url", elem);
            },
            ...
            onEmptyUserError: function(elem) {
                this.handle("user", elem);
            },

            onEmptyTokenError: function(elem) {
                this.handle("token", elem);
            },

            onEmptyCertificatesError: function(elem) {
                this.handle("certificates", elem);
            },

            onInvalidCertificatesError: function(elem) {
                this.handle("certificates", elem);
            },
...
TaskConnectionSettingsForm = OO.extend(PtaiConnectionSettingsForm, {
    ...
    * */
    ...
    toggle: function(global) {
        if (global)
            $j("#ai-connection-settings").find(".ai-connection-settings-local").hide();
        else
            $j("#ai-connection-settings").find(".ai-connection-settings-local").show();
