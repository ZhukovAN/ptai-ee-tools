...
@Slf4j
public class AiProjV13ScanSettings extends UnifiedAiProjScanSettings {
    ...
    public AiProjV13ScanSettings(@NonNull final JsonNode rootNode) {
        super(rootNode);
    }

    @Override
    public @NonNull String getJsonSchema() {
        return ResourcesHelper.getResourceString("aiproj/schema/aiproj-v1.3.json");
    }
    ...
    public @NonNull ScanBrief.ScanSettings.Language getProgrammingLanguage() {
        log.trace("No common ProgrammingLanguage support for AIPROJ schema v.1.3");
    ...
    public String getCustomParameters() {
        log.trace("No common CustomParameters flag support for AIPROJ schema v.1.3");
        return null;
    }

    @Override
    public UnifiedAiProjScanSettings setCustomParameters(String parameters) {
        log.trace("No common PublicAnalysisMethod flag support for AIPROJ schema v.1.3");
        return this;
    }
    ...
    public @NonNull Boolean isUseCustomYaraRules() {
        log.trace("No custom SAST rules support for AIPROJ schema v.1.3");
        return false;
    }
    ...
    public @NonNull Boolean isDownloadDependencies() {
        log.trace("No common DownloadDependencies flag support for AIPROJ schema v.1.3");
        return false;
    }
